...
function normalizeReason(value: unknown) {
  ...
  const aliases: Record<string, string> = {
    "некоректний опис": "Некорректное описание",
    "некорректний опис": "Некорректное описание",
    "некорректное описание": "Некорректное описание",
    "некоректное описание": "Некорректное описание",

    "неправильні характеристики": "Неправильные характеристики",
    "неправильные характеристики": "Неправильные характеристики",
    "невірні характеристики": "Неправильные характеристики",
    "неверные характеристики": "Неправильные характеристики",

    "підозра на підробку": "Подозрение на подделку",
    "подозрение на подделку": "Подозрение на подделку",

    "заборонений товар": "Запрещённый товар",
    "запрещенный товар": "Запрещённый товар",
    "запрещённый товар": "Запрещённый товар",

    "інше": "Другое",
    "інша причина": "Другое",
    "другое": "Другое",
    "другая причина": "Другое",
  };
